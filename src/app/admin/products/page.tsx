    ...
    <div>
      ...
      {isEditing && (
        <div className="fixed inset-0 z-[9999] bg-black/80 flex items-center justify-center p-4">
          <div className="bg-white w-full max-w-2xl border-[4px] border-black p-8 shadow-[10px_10px_0_#111] max-h-[90vh] overflow-y-auto">
            <h2 className="font-cartoon text-4xl mb-6">{currentProduct.id ? 'EDIT PRODUCT' : 'NEW PRODUCT'}</h2>
            ...
            <div className="flex justify-end gap-4 mt-8">
              <button onClick={() => setIsEditing(false)} className="px-6 py-2 border-[3px] border-black font-black hover:bg-gray-100">CANCEL</button>
              <button onClick={handleSave} className="px-6 py-2 border-[3px] border-black bg-black text-white font-black hover:bg-[var(--color-electric-blue)]">SAVE IT</button>
            </div>
          </div>
        </div>
      )}
